...
public class Client {
    ...
    public static JSONObject switching() {
        ...
        {
        	try {
        		System.out.print("Enter which index should be reversed: ");
        		strToSend = stdin.readLine();
        		strToSend.trim(); 
         	    int test = Integer.parseInt(strToSend);
         	    clear = false; 
        	} 
        	catch(NumberFormatException e)
        	{
        		System.out.println("Please enter a number (eg: 4)"); 
        		clear = true; 
        	} catch (IOException e) {
        		e.printStackTrace(); 
        	}
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            do {
                ...
                System.out.println("5. reserve <int> - reserve a string in the list");
            	...
            	{
                	choice = 1; 
                	System.out.println("Number not entered. Add option chosen for you. Next time enter a 0-6."); 
                	input.nextLine(); 
            	}
